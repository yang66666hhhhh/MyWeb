      ...
      <Form layout="inline" :model="query">
        ...
        <Form.Item>
          <Space>
            ...
            <Button v-if="hasPermission('GROWTH_SKILL')" @click="openCreate">新建复盘</Button>
          </Space>
        </Form.Item>
      </Form>
    </Card>
      ...
      >
        <template #bodyCell="{ column, record }">
          ...
          <template v-else-if="column.key === 'action'">
            <Space>
              <Button v-if="hasPermission('GROWTH_SKILL')" size="small" type="link" @click="openEdit(record as MonthlyReview)">编辑</Button>
