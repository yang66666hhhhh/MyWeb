      ...
      <Form layout="inline" :model="query">
        ...
        <Form.Item>
          <Space>
            ...
            <Button v-if="hasPermission('GROWTH_SKILL')" @click="openCreate">新建路径</Button>
          </Space>
        </Form.Item>
      </Form>
    </Card>
      ...
      >
        <template #bodyCell="{ column, record }">
          ...
          <template v-else-if="column.key === 'action'">
            <Space>
              <Button v-if="hasPermission('GROWTH_SKILL')" size="small" type="link" @click="openEdit(record as LearningPath)">编辑</Button>
