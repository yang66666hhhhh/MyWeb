...
using WebApplication1.Entities.Work;
...
public class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
{
    ...
    private void UpdateTimestamps()
    {
        ...
        {
            if (entry.Entity is Entities.EntityBase baseEntity)
            {
    ...
    private static void ConfigureDailyPlan(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<DailyPlan>(entity =>
        {
            ...
            entity.Property(x => x.PlanDate).HasColumnType("date").IsRequired();
            entity.Property(x => x.Title).HasMaxLength(120).IsRequired();
            entity.Property(x => x.Description).HasMaxLength(1000);
            entity.Property(x => x.Priority).HasDefaultValue(3);
            entity.Property(x => x.Status).HasConversion<int>().HasDefaultValue(Enums.DailyPlanStatus.Pending);
    ...
    private static void ConfigureWorkProject(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<WorkProject>(entity =>
        {
            ...
            entity.Property(x => x.ProjectType).HasConversion<int>().HasDefaultValue(Enums.WorkProjectType.Internal);
            entity.Property(x => x.CustomerName).HasMaxLength(100);
            entity.Property(x => x.Description).HasMaxLength(1000);
            entity.Property(x => x.Status).HasConversion<int>().HasDefaultValue(Enums.WorkProjectStatus.Active);
            entity.Property(x => x.CreatedAt).HasColumnType("datetime");
    ...
    private static void ConfigureWorkDevice(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<WorkDevice>(entity =>
        {
            ...
            entity.Property(x => x.DeviceType).HasConversion<int>().HasDefaultValue(Enums.WorkDeviceType.Equipment);
            entity.Property(x => x.Description).HasMaxLength(1000);
            entity.Property(x => x.Status).HasConversion<int>().HasDefaultValue(Enums.WorkDeviceStatus.Active);
            entity.Property(x => x.CreatedAt).HasColumnType("datetime");
    ...
    private static void ConfigureWorkLog(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<WorkLog>(entity =>
        {
            ...
            entity.HasKey(x => x.Id);
            entity.Property(x => x.WorkDate).HasColumnType("date").IsRequired();
            ...
            entity.Property(x => x.Status).HasConversion<int>().HasDefaultValue(Enums.WorkLogStatus.Normal);
            entity.Property(x => x.SourceType).HasConversion<int>().HasDefaultValue(Enums.WorkLogSourceType.Manual);
            entity.Property(x => x.Remark).HasMaxLength(1000);
            entity.Property(x => x.CreatedAt).HasColumnType("datetime");
    ...
    private static void ConfigureWorkImport(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<WorkImportBatch>(entity =>
        {
            ...
            entity.Property(x => x.Status).HasConversion<int>().HasDefaultValue(Enums.WorkImportStatus.Pending);
            entity.Property(x => x.ImportStrategy).HasConversion<int>().HasDefaultValue(Enums.WorkImportStrategy.SkipDuplicate);
        ...
        modelBuilder.Entity<WorkImportRow>(entity =>
        {
            ...
            entity.Property(x => x.ValidationStatus).HasConversion<int>().HasDefaultValue(Enums.WorkImportValidationStatus.Valid);
            entity.Property(x => x.CreatedAt).HasColumnType("datetime");
